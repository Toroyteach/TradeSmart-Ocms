...
/* C:\xampp\htdocs\tradesmartconsult\TradeSmart/plugins/rainlab/blog/components/post/default.htm */
class __TwigTemplate_1a8d397b0631132b4bef92587c72867bc6c5a39d94b391d1c14f81b29f6e0e39 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    public function __construct(Environment $env)
    {
        ...
        $filters = array("raw" => 3, "escape" => 9, "date" => 22);
        $functions = array();
...
";
        ...
        ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["image"]) {
                ...
                <img data-src=\"";
                // line 9
                echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["image"], "filename", [], "any", false, false, true, 9), 9, $this->source), "html", null, true);
                echo "\" src=\"";
                ...
                echo "\" alt=\"";
                echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["image"], "description", [], "any", false, false, true, 9), 9, $this->source), "html", null, true);
...
<p class=\"info\">
    ...
    ";
        // line 17
        if (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["post"] ?? null), "categories", [], "any", false, false, true, 17), "count", [], "any", false, false, true, 17)) {
            echo " in
        ";
            // line 18
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, ($context["post"] ?? null), "categories", [], "any", false, false, true, 18));
            $context['loop'] = [
        ...
        // line 22
        echo "    on ";
        echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["post"] ?? null), "published_at", [], "any", false, false, true, 22), 22, $this->source), "M d, Y"), "html", null, true);
        echo "
</p>
";
    }
    ...
    {
        return "C:\\xampp\\htdocs\\tradesmartconsult\\TradeSmart/plugins/rainlab/blog/components/post/default.htm";
    }
    ...
    {
        return array (  153 => 22,  150 => 21,  136 => 20,  127 => 19,  110 => 18,  106 => 17,  101 => 14,  97 => 12,  84 => 9,  81 => 8,  77 => 7,  74 => 6,  72 => 5,  67 => 3,  64 => 2,  62 => 1,);
    }
